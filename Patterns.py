...
def name_pattern(record: dict, character: str) -> dict:
    ...
    if character == "relative":
        if record["relative"]["relation_degree"] == "отец":
            relative_text = "<u>отец</u> умершего ребенка;"
            deceased = "<u>Ребенок</u>"
        elif record["relative"]["relation_degree"] == "муж":
            relative_text = "<u>муж</u> умершей;"
            deceased = "<u>Жена</u>"
        else:
            if record["deceased"]["gender"] == "ж":
                relative_text = "<u>родственник</u> умершей;"
                deceased = "<u>Родственница</u>"
            else:
                relative_text = "<u>родственник</u> умершего;"
    ...
    if character == "participant":
        if record["participant"]["gender"] == "ж":
...
def full_name_reg():
    ...
    Нужно для проверки корректности ввода данных с учетом правил замены отсутствующих элементов имени на "...".
    """
    return r"[а-яёА-ЯЁ\.]+ [а-яёА-ЯЁ\.]+ [а-яёА-ЯЁ\.]+"
...
def record_pattern(rec_type, rec_raw, rec_id, settings):
    ...
    if rec_type == "Births":
        ...
        record = {
            ...
            "date": date,
            "newborn": {
                "familia": newborn_familia,
                "name": newborn_name,
                "patronym": newborn_patronym,
                "gender": gender
            },
    ...
    if rec_type == "Deaths":
        ...
        record = {
            ...
            "date": date,
            "deceased": {
                "familia": deceased_familia,
                "name": deceased_name,
                "patronym": deceased_patronym,
                "gender": gender
            },
